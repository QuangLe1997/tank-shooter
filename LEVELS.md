...
> **ARC MORTAR (Z61):** súng pháo **bắn vòng cung Y HỆT SIEGE ROCKET** (cùng độ nghiêng ~60°, cùng cách ngắm: desktop = con trỏ chuột / mobile = địch gần nhất; lốp qua tường, đánh mục tiêu tầm xa hay núp sau cover) — **KHÁC ở chỗ: nổ NGAY khi chạm đất** (không cầu chì 2s như rocket) và **bắn liên thanh nhiều phát như súng thường** (băng 6, hồi 0.95s, nạp 3.4s). **Sức mạnh thấp hơn rocket** (dmg 30 + AoE bán kính 5, KHÔNG xoá sổ vùng). Nòng = **ống cối lùn-mập** trên bệ (khác ống phóng cao của SIEGE). Shop 3.800 xu / rơi từ màn 3.
