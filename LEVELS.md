...
> **SIEGE ROCKET (Z55–Z56):** nòng = **ống phóng chĩa lên trời, hơi xéo** (warhead ló ra). **Rơi ĐÚNG vị trí con trỏ chuột** (desktop) — bắn vào ô trống cũng được; mobile thì auto-khoá địch gần nhất. Lốp lên → cầu chì 2s → **nổ xoá vùng bán kính 15** (boss 360 dmg). **Z56:** khi cầm khẩu này có **xem trước đường đạn giả định** — vòng cung **chấm đỏ tương phản cao** (vẽ đè lên địa hình, không bị che) từ ống phóng tới điểm rơi + **reticle bán kính nổ** (vòng + nền đỏ mờ, scale = bán kính 15) ngay điểm rơi; lúc phóng **rung xe mạnh (shake 2.4) + giật lùi ~5.5** + **lửa/khói phụt ngược dưới ống** (backblast).
