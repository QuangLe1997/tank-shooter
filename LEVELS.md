...
> **SIEGE ROCKET (Z55–Z59):** nòng = **ống phóng chĩa lên trời, hơi xéo** (warhead ló ra). **Z59:** dựng lại ống phóng thành **1 khối tròn 3D đặc** — vỏ trụ 32 cạnh (tròn mượt), **lòng ống tối render 2 mặt (DoubleSide) nên nhìn THẤY VÀO trong ống = có chiều sâu thật**, vành miệng (torus), 3 đai gia cố, warhead nằm trong nòng ló mũi ra; cả cụm là 1 group cứng nghiêng 1 lần (hết cảnh hở/dẹt/lệch như cũ). **Rơi ĐÚNG vị trí con trỏ chuột** (desktop) — bắn vào ô trống cũng được; mobile thì auto-khoá địch gần nhất. Lốp lên → cầu chì 2s → **nổ xoá vùng bán kính 15** (boss 360 dmg). **Z56:** khi cầm khẩu này có **xem trước đường đạn giả định**; lúc phóng **rung xe mạnh (shake 2.4) + giật lùi ~5.5** + **lửa/khói phụt ngược dưới ống** (backblast). **Z57:** tên lửa **phóng ra ĐÚNG từ miệng ống** (muzzle = miệng nòng) và bay **đúng độ nghiêng của ống (~60° lên trời)** — tốc độ được giải để vẫn rơi trúng đích; preview + đạn thật dùng chung điểm xuất phát & quỹ đạo nên luôn khớp. **Z58:** preview giờ **chỉ là 1 vòng cung chấm đỏ nhỏ & mờ** (26 chấm, tương phản đủ thấy, hơi mờ dần về điểm rơi) — **BỎ vòng tròn/đĩa đỏ bán kính nổ** (vùng nguy hiểm chỉ hiện SAU khi đã bắn ra, lúc đạn đang bay/đếm ngược).
