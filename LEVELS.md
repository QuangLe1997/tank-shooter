...
> **SIEGE ROCKET (Z55–Z58):** nòng = **ống phóng chĩa lên trời, hơi xéo** (warhead ló ra). **Rơi ĐÚNG vị trí con trỏ chuột** (desktop) — bắn vào ô trống cũng được; mobile thì auto-khoá địch gần nhất. Lốp lên → cầu chì 2s → **nổ xoá vùng bán kính 15** (boss 360 dmg). **Z56:** khi cầm khẩu này có **xem trước đường đạn giả định**; lúc phóng **rung xe mạnh (shake 2.4) + giật lùi ~5.5** + **lửa/khói phụt ngược dưới ống** (backblast). **Z57:** tên lửa **phóng ra ĐÚNG từ miệng ống** (muzzle = miệng nòng) và bay **đúng độ nghiêng của ống (~60° lên trời)** — tốc độ được giải để vẫn rơi trúng đích; preview + đạn thật dùng chung điểm xuất phát & quỹ đạo nên luôn khớp. **Z58:** preview giờ **chỉ là 1 vòng cung chấm đỏ nhỏ & mờ** (26 chấm, tương phản đủ thấy, hơi mờ dần về điểm rơi) — **BỎ vòng tròn/đĩa đỏ bán kính nổ** (vùng nguy hiểm chỉ hiện SAU khi đã bắn ra, lúc đạn đang bay/đếm ngược).
